...
class GeneticAlgorithmSolver:
    ...
    def check_hall_solution_quality(self, export_to_graph=False):
        ...
        for course, halls in self.best_child.halls_assignment_dict.items():
            course_obj = self.best_child.reverse_courses_dict[course].get_name()
        ...
        if export_to_graph:
            return course_to_unfair_assignment, num_of_unfair_courses, student_chair_halls, self.best_child.n_halls,\
